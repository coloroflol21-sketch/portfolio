...
- Нужен пруф автоматизации: кейс 1 (открытый код) и кейс 2 (рабочий конвейер).
- Нужна точность с данными: кейс 3, ссылка на таблицу открывается.
- Нужен полный цикл продукта: кейс 5.
