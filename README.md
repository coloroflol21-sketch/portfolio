...
- Сайт на чистом HTML и CSS без фреймворков, хостинг GitHub Pages: https://tuevksxx.github.io/genregap/ (живой), репозиторий: https://github.com/Tuevksxx/genregap.
- Полный продукт, а не заглушка: лендинг с ценами и условиями, состав полного отчёта, страницы разборов, бесплатный сэмпл, FAQ со способами оплаты, форма заявки, срок готовности разбора 48 часов.
- Конвейер: сборщик отзывов (кейс 7) → разбор корпуса → отчёт с цитатами игроков и картой претензий по жанру.
- Бизнес не выстрелил, но рабочие части все на месте и открываются: сайт живой, сборщик отработал на реальных играх.
...
- Собирал корпуса по трём десяткам игр (Phasmophobia, Lethal Company, REPO, Monster Train, Wildfrost, Cobalt Core), около 150 МБ данных.
